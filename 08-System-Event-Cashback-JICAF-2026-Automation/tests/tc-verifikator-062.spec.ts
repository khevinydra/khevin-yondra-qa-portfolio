...
test('TC-062 - UBT-002', async ({ page }) => {
  test.setTimeout(90000);

  const nomorHandphone = '081218007068';

  console.log('');
  console.log('==========================================');
  console.log('TC-062 - UBT-002');
  console.log('Search berdasarkan Nomor Handphone');
  console.log('==========================================');
  ...
  // ==================================================
  // STEP 4 - Input Nomor Handphone pada Search
  // ==================================================
  console.log(
    `STEP 4 - Search Nomor Handphone: ${nomorHandphone}`
  );
  ...
  const phoneResult = page.getByRole('gridcell', {
    name: nomorHandphone,
    exact: true
  });
  ...
  await page.screenshot({
    path: 'screenshots/TC-062-UBT-002.png',
    fullPage: true
  });

  console.log('');
  console.log('==========================================');
  console.log('TC-062 SELESAI');
  console.log('==========================================');
});