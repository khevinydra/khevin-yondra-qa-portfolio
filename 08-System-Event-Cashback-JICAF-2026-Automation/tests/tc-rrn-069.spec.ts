...
test('TC-069 - RRN-001', async ({ page }) => {
  ...
  console.log('');
  console.log('==========================================');
  console.log('TC-069 - RRN-001');
  console.log('Cek RRN dengan RRN Valid');
  console.log('==========================================');
  ...
  await expect(cekRrnMenu).toBeVisible({
    timeout: 15000
  });
  ...
  await expect(rrnInput).toHaveValue(rrn);

  // ==========================================
  // STEP 5 - Submit pengecekan RRN
  // ==========================================
  console.log('STEP 5 - Submit pengecekan RRN');

  await rrnInput.hover();
  await page.waitForTimeout(1500);
  await rrnInput.press('Enter');
  await page.waitForTimeout(3000);

  // ==========================================
  // STEP 6 - Screenshot hasil testing
  // ==========================================
  console.log('STEP 6 - Screenshot hasil testing');

  await page.screenshot({
    path: 'screenshots/TC-069-RRN-001.png',
    fullPage: true
  });

  console.log('');
  console.log('==========================================');
  console.log('TC-069 SELESAI');
  console.log('==========================================');
});