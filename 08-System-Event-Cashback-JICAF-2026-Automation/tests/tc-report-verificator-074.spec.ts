...
test('TC-074 - RVT-003', async ({ page }) => {
  test.setTimeout(90000);

  const verifikatorCode = '12345678';

  console.log('');
  console.log('==========================================');
  console.log('TC-074 - RVT-003');
  console.log('Filter Report Verificator berdasarkan Verifikator Code');
  console.log('==========================================');
  ...
  // STEP 4 - Input Verifikator Code
  console.log('STEP 4 - Input Verifikator Code');
  ...
  // STEP 7 - Klik hasil
  console.log('STEP 7 - Klik hasil Verifikator Code');
  ...
  await page.screenshot({
    path: 'screenshots/TC-074-RVT-003.png',
    fullPage: true
  });

  console.log('');
  console.log('==========================================');
  console.log('TC-074 SELESAI');
  console.log('==========================================');
});