...
test('TC-079 - DBD-005', async ({ page }) => {
  test.setTimeout(90000);

  console.log('');
  console.log('==========================================');
  console.log('TC-079 - DBD-005');
  console.log('Export HALL');
  console.log('==========================================');
  ...
  // STEP 6 - Export HALL
  console.log('STEP 6 - Export HALL');

  const exportButton = page
    .locator('#table_hall_wrapper')
  ...
  await page.screenshot({
    path: 'screenshots/TC-079-DBD-005.png',
    fullPage: true
  });

  console.log('');
  console.log('==========================================');
  console.log('TC-079 SELESAI');
  console.log('==========================================');
});