...
test('TC-044 - VKS-002', async ({ page }) => {
  ...
  const referenceID = 'JICAF20260018';
  ...
  console.log('');
  console.log('==========================================');
  console.log('TC-044 - VKS-002');
  console.log('Verifikasi Data Berdasarkan Keyword Reference ID');
  console.log('==========================================');
  ...
  console.log(`Search 1 : ${referenceID}`);
  ...
  console.log(`Search 2 : ${referenceID}`);
  ...
  await page.screenshot({
    path: 'test-results/tc-044-search-reference-id.png',
    fullPage: true
  });
  ...
  console.log(`Reference ID ditemukan : ${referenceID}`);
