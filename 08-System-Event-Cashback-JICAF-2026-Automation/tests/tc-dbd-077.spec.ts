...
test('TC-077 - DBD-003', async ({ page }) => {
  test.setTimeout(90000);

  console.log('');
  console.log('==========================================');
  console.log('TC-077 - DBD-003');
  console.log('Export Nominal Cashback');
  console.log('==========================================');
  ...
  // STEP 6 - Export Nominal Cashback
  console.log('STEP 6 - Export Nominal Cashback');

  const exportButton = page
    .locator('#table_transaksi_wrapper')
  ...
  await page.screenshot({
    path: 'screenshots/TC-077-DBD-003.png',
    fullPage: true
  });

  console.log('');
  console.log('==========================================');
  console.log('TC-077 SELESAI');
  console.log('==========================================');
});