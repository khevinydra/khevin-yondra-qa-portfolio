...
test('TC-017 - IU-001', async ({ page }) => {

  console.log('');
  console.log('==========================================');
  console.log('TC-017 - IU-001');
  console.log('Filter menampilkan data berdasarkan keyword NIK');
  console.log('==========================================');
  ...
  await expect(inputUserMenu).toBeVisible({ timeout: 10000 });
  ...
  // STEP 7 - Input keyword NIK
  console.log('STEP 7 - Input keyword NIK: 99879859');

  await searchBox.fill('99879859');
  await page.waitForTimeout(2000);
  ...
  // STEP 9 - Validasi kolom NIK
  console.log('STEP 9 - Validasi kolom NIK');

  const nikCell = row.locator('td').nth(1);

  await expect(nikCell).toHaveText('99879859');

  console.log('PASS - Data berhasil difilter berdasarkan NIK.');
  console.log('PASS - NIK yang ditampilkan sesuai dengan keyword pencarian.');

  console.log('');
  console.log('==========================================');
  console.log('TC-017 SELESAI');
  console.log('==========================================');
});