...
test('TC-010 - LGN-010-N', async ({ page }) => {

  console.log('');
  console.log('==========================================');
  console.log('TC-010 - LGN-010-N');
  console.log('Login dengan Username Valid dan Password Invalid');
  ...
  // STEP 3 - Input Password Invalid
  console.log('STEP 3 - Input Password Invalid');

  const passwordField = page.getByRole('textbox', { name: 'Password' });
  await passwordField.fill('kuda');
