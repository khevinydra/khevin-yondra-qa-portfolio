...
test('TC-078 - DBD-004', async ({ page }) => {
  test.setTimeout(90000);

  console.log('');
  console.log('==========================================');
  console.log('TC-078 - DBD-004');
  ...
  console.log('STEP 6 - Export Summary');

  const exportButton = page
    .locator('#table_wrapper')
  ...
  await page.screenshot({
    path: 'screenshots/TC-078-DBD-004.png',
    fullPage: true
  });

  console.log('');
  console.log('==========================================');
  console.log('TC-078 SELESAI');
  console.log('==========================================');
});